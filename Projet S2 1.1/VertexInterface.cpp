...
///permet de simplifier les sommet
void VertexInterface::modifier_interface_reduit()
{
    m_top_box.remove_child(m_slider_value);
    m_top_box.remove_child(m_label_value);
    //m_top_box.remove_child(m_box_label_idx);
    m_top_box.set_dim(100,100);
    m_img.set_gravity_xy(grman::GravityX::Left, grman::GravityY::Down);
}
...
//    m_slider_value.set_gravity_xy(grman::GravityX::Left, grman::GravityY::Up);
    ...
    if (pic_name!="")
    {
        std::cout<<"je creer un widget img"<<std::endl;
        m_top_box.add_child( m_img );
        std::cout<<"je lui met le nom:"<<pic_name<<std::endl;
